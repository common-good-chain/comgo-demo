<template>
  <div class="column is-10">
    ...
    <div v-if="talentsToShow.length" class="columns is-multiline">
      <div
    ...
    <div v-else class="box empty-state-box has-text-centered">
      <div class="content">
        <h2 class="title is-size-4 has-text-grey">
          No hay resultados para esta categoría 🤦‍♀️
        </h2>
        <p class="subtitle has-text-grey-light">
          Si buscas a alguien concreto, puede que esté en otra categoría.
          ¡Prueba a usar la barra de búsqueda!
        </p>
      </div>
    </div>
  </div>
...
export default {
  ...
  props: ['talentsToShow', 'sortTalentsBy'],
  methods: {
